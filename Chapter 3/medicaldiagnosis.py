...
print response and collect input again
if user_response == yes print you have it again
if user_response == no print you have it now

"""

user_problem = input("What is your problem?: ")
user_history = input("Have you had this problem before? (Yes or No): ").lower()

if user_history == "yes":
    print("Well, you have it again")

elif user_history == "no":
    print("Well, you have it now")


"""
yes it would, because it assed a question, got answer and seemingly asked a follow up question which it then responded to accordingly.
"""
