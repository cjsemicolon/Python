...
5. Go back to step 2 and check traffic again.----------------------loop
6. If no cars are coming and the road is clear, go to step 7.
7. Walk straight across the road while continuing to look both ways.
8. Reach the other side safely.'''
